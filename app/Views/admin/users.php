                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link " href="<?= base_url('daftarmenu'); ?>">Daftar Menu</a>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= esc($row->kelas); ?></td>
                                            <td>
                                                <a title="Edit" href="<?= base_url("daftaruser/update/" . $row->id); ?>" class="btn btn-primary">Edit</a>
                                                <a title="Delete" href="<?= base_url("daftaruser/delete/" . $row->id); ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
