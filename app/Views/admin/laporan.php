            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="<?= site_url('sales') ?>">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Daftar Laporan
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= esc($no++); ?></td>
                                            <td><?= date('d M Y H:i:s', strtotime($row->tanggal_penjualan)); ?></td>
                                            <td><?= esc($row->nama); ?></td>
                                            <td><?= esc($row->alamat); ?></td>
                                            <td><?= esc($row->nomor_telepon); ?></td>
                                            <td>Rp <?= number_format($row->total_harga, 0, ',', '.'); ?></td>
                                            <td><?= esc($row->metode_pembayaran); ?></td>
                                            <td>
                                                <a href="<?= base_url("sales/details/{$row->id_penjualan}"); ?>" class="btn btn-info btn-sm">Detail</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
