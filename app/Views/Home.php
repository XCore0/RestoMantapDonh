...
<head>
    <meta charset="utf-8" />
    <title>Restoran Mantap Donh - Home</title>
                ...
                <div class="container-xs">
                    <div class="columnrasakan">
                        ...
                        <div class="rowlihat_menu">
                            <a href="<?= site_url('menu') ?>">
                                <button class="lihat_menu-2 ui button blue_gray_900 size-lg fill round">Lihat
                                    Menu</button>
                            </a>
                ...
                <div class="rowulasan">
                    <div class="column_nine">
                        <div class="column_seven container-xs">
                            ...
                            <p class="description ui text size-textmd">
                                Dengarkan apa yang dikatakan oleh pelanggan setia kami tentang pengalaman mereka di
                                Restoran
                        ...
                        <div class="listandi">
                            <div class="columndescripti">
                                ...
                                <p class="description-2 ui text size-textxs">
                                    Gado-gadonya segar dan saus kacangnya sangat lezat. Stafnya juga sangat membantu.
                                    Sangat
                        ...
                        <div class="column_eight container-xs">
                            <a href="<?= site_url('menu') ?>">
                                <button class="lihat_menu ui button gray_300 size-xl fill round">Lihat Menu
                                    Lengkap</button>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="rowmap">
                            <div class="columnmap">
                                ...
                                <div class="rowtelepon">
                                    ...
                                    <p class="telepon ui text size-textmd">Jl. Raya Mantap No. 123, Jakarta,
                                        Indonesia</p>
                                </div>
                                <div class="rowtelepon">
